...
POSSIBLE_PATHS = [
    ...
    "data/Inria_Processed/img_dir/train", 
    "data/Inria/Train/images"
]
DATA_ROOT = None
...
if DATA_ROOT is None:
    # 根据你的日志，这应该是正确路径
    DATA_ROOT = "/root/user/cs_tcci_penghai/mch/SegEarth-OV-3/data/Inria/train/images"

# 2. 原型文件 (Inria 专属)
PROTOTYPE_PATH = os.path.join(parent_dir, "weights/inria_prototypes.pkl")

# 3. DINO 权重
DINO_WEIGHT_PATH = os.path.join(parent_dir, "weights/dinov3/model.safetensors")

# 4. 输出目录
OUTPUT_DIR = os.path.join(parent_dir, "vis_clusters_inria")
